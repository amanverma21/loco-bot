...
setInterval(() => {
  http.get(`http://$https://nonstop-line.glitch.me/`);
}, 280000);
...
client.login("NDY5NDMyMTAzNDU3NzgzODA5.D0xupw.RmC60gD60hE8vkeLpH9Yt5xb-5A", output);
bot.login("NTYxMDc2NTg1MzE5NDk3NzI4.D3-OpA.XibvXvgoLpoPCIkyv300jskshLY", output);
 
bot.on('ready', () => {
  bot.user.setGame('Loco Trivia !!')
})
 ...
 /** @type {!Array} */
var lochannels = ["576083638861692928","576083809758609428","557601050190675973","553161695397281803","557811124112982016","541852998280675358","537102383503638538","576295352278188044",];
/** @type {!Array} */
